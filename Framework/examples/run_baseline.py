...
def build_environment(scale: str, scheduler_name: str) -> Environment:
    ...
    sim_config = SimulationConfig(end_time=scenario.horizon)
...
def main() -> None:
    ...
    env = build_environment(scale=args.scale, scheduler_name=args.scheduler)
    summary = env.run()
